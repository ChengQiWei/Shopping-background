...
CREATE TABLE `tbl_goods` (
  ...
  `goods_brand` varchar(256) NOT NULL DEFAULT '',
  `goods_place` varchar(256) NOT NULL DEFAULT '',
  `goods_price` float NOT NULL,
  `goods_abstract` varchar(256) NOT NULL DEFAULT '',
  `goods_class` int(11) NOT NULL DEFAULT '0',
  `goods_adddate` date NOT NULL,
  `goods_image` int(11) NOT NULL DEFAULT '0',
...
-- Dump completed on 2020-05-19 15:04:52
