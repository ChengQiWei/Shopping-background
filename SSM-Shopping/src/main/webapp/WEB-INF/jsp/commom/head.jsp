    ...
    <nav class="navbar navbar-inverse navbar-static-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" id="company_logo" href="#">购物网站后台系统</a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu nav nav-pills nav-stacked">
                            <li class="active"><a href="#" role="button" class="admin_update_btn" data-toggle="modal" data-target=".admin-update-modal"><span class="glyphicon glyphicon-pencil" aria-hidden="true" ></span> 修改信息</a></li>
