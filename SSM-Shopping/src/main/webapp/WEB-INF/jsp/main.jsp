        ...
        <div class="hrms_main_ad col-sm-10">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 style="text-align: center;">欢迎进入购物网站后台管理系统！</h3>
                </div>
                    ...
                    <div id="hrms_carousel_1" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active" style="text-align: center;">
                                <img class="img-responsive center-block" src="<%=request.getContextPath()%>/static/img/website3.jpg" alt="website3">
                                <div class="carousel-caption">
                                </div>
                            </div>
                            <div class="item">
                                <img class="img-responsive center-block" src="<%=request.getContextPath()%>/static/img/website4.jpg" alt="website4">
                                <div class="carousel-caption">
                                </div>
                            </div>
                        </div>
